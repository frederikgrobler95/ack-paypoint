          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full max-w-md">
            ...
            {!scannedCode ? (
              <button
                ...
                onClick={handleScan}
                disabled={isScanning}
                className="flex-1 px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-neutral-50 bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50"
              >
              ...
              <button
                ...
                className="flex-1 px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-neutral-50 bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
              >
                Confirm Reissue
              </button>
            )}
