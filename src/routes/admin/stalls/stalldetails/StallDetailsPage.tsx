      ...
      <div className="flex justify-center items-center h-64">
        <div className="text-center p-4 bg-red-50 rounded-lg">
          ...
          <button
            ...
            className="mt-4 bg-indigo-600 hover:bg-indigo-700 text-neutral-50 font-medium py-2 px-4 rounded-md transition duration-300 ease-in-out"
          >
            Retry
          </button>
        </div>
        ...
        <div className="border-t border-gray-200 pt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <button
              ...
              className="bg-indigo-600 hover:bg-indigo-700 text-neutral-50 font-medium py-3 px-4 rounded-lg transition duration-300 ease-in-out flex items-center justify-center"
            >
            ...
            <button
              ...
              className="bg-green-600 hover:bg-green-700 text-neutral-50 font-medium py-3 px-4 rounded-lg transition duration-300 ease-in-out flex items-center justify-center"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
