  ...
  return (
    <FlowContainer withHeaderOffset withBottomOffset>
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-6">Sales Tutorial</h1>
        
        <div className="mb-6">
          <h2 className="text-lg font-semibold text-gray-700 mb-3">Overview</h2>
          <p className="text-gray-600 mb-4">
            This tutorial will guide you through the process of making a sale in the system.
          </p>
          <p className="text-gray-600 mb-4">
            You'll learn how to:
          </p>
          <ul className="list-disc list-inside text-gray-600 mb-4">
            <li>Scan a customer's QR code</li>
        ...
        <div className="mb-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li className="text-gray-700">Enter Sale Amount</li>
              <li className="text-gray-700">Confirm Transaction</li>
            </ol>
          </div>
        </div>
