...
const checkoutTutorialSteps = [
  {
    ...
    content: 'This section shows the details of the transaction you are refunding.',
    disableBeacon: true,
  },
  {
    target: '.reason-input',
    content: 'Enter a reason for the refund. This is required for all refunds.',
  },
  {
    target: '.refund-button',
    content: 'Click this button to process the refund after entering a reason.',
  },
];

function RefundsStep3Tutorial() {
  ...
  const handleCompleteTutorial = () => {
    ...
    navigate('/tutorial/checkout/step4');
  };
  ...
  return (
    <FlowContainer withNoHeaderOffset withBottomOffset>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-6">Checkout Tutorial - Step 3</h1>
        
        <div className="mb-6">
          <h2 className="text-lg font-semibold text-gray-700 mb-3">Tutorial Instructions</h2>
          <p className="text-gray-600 mb-4">
            In this step, you'll learn how to process a refund for a selected transaction.
          </p>
...
export default withTutorial(RefundsStep3Tutorial, 'checkout');