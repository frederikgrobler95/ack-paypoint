      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mb-4">
            Welcome to the Checkout tutorial! In this step, you'll learn how to scan a customer's QR code for a refund.
          </p>
...
export default withTutorial(RefundsStep1Tutorial, 'checkout');