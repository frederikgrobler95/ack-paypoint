...
function CheckoutStep1Tutorial() {
  const navigate = useNavigate();
  const { mockData, onCompleteTutorial } = useTutorialStore();
  ...
  return (
    <FlowContainer withHeaderOffset withBottomOffset>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-6">Checkout Tutorial - Step 1</h1>
        
        <div className="mb-6">
          <h2 className="text-lg font-semibold text-gray-700 mb-3">Tutorial Instructions</h2>
          <p className="text-gray-600 mb-4">
            Welcome to the Checkout tutorial! In this step, you'll learn how to scan a customer's QR code.
          </p>
        ...
        <div className="mb-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <p className="text-gray-700 mb-2">
              <span className="font-medium">Customer:</span> {mockData.checkout.items[0].name}
            </p>
...
export default withTutorial(CheckoutStep1Tutorial, 'checkout');