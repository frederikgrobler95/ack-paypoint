  ...
  return (
    <FlowContainer withHeaderOffset withBottomOffset>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-6">Sales Tutorial - Step 1: Scan QR Code</h1>
        
        <div className="mb-6">
          <h2 className="text-lg font-semibold text-gray-700 mb-3">Tutorial Instructions</h2>
          <p className="text-gray-600 mb-4">
            In this step, you'll learn how to scan a customer's QR code to begin a sale.
          </p>
      ...
      <div className="fixed bottom-4 left-0 right-0 bg-white p-4 border-t border-gray-200 tutorial-navigation">
        <div className="flex justify-between">
          ...
          <div className="space-x-2">
            ...
            <button
              onClick={() => navigateToNextTutorialStep('/tutorial/sales/step1')}
